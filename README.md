in the file index.js it is determined if there is stormy weather or not, using the Math.random function. In the tests, the weather variable is set as required for the tests.
