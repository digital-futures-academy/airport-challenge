...
console.log("---------------------");
console.log("A plane can not land if it has already landed at the airport")
...
plane2 = new Plane(2);
airport.landPlane(plane2);
expected = `Plane ${plane2.getId()} has already landed at the airport`;
...
//Assert
result = assertEquals(actual, expected);
console.log(`Test 5d - landPlane() returns a string stating that a plane has already landed if it is in the parkedPlanes array: ${result}`);
