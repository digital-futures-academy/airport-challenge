...
//Test 1: the max capacity can be overridden with the capacityMutator() function 
console.log('Test 1: the max capacity can be overridden with the capacityMutator() function ');
//Arrange
...
//Test 2: the max capacity only accepts numbers (no floats/half a plane)
//though maybe for this feature, it could still use floats but drop numbers past dp?
console.log('Test 2: the max capacity only accepts numbers');
//Arrange
input = 5.5;
...
//Test 3: the max capacity only accepts numbers (no strings/stop runtime errors if maxCap gets to NaN)
